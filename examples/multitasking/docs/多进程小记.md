...
描述：为什么多进程代码（开2个处理进程）在虚拟机Tom下`webbench -t 10 -c 2`的QPS比串行的还小？
- 20220718测试：虚拟机Tom。串行代码连续测试3次，稳定在61000pages/min。多进程代码连续测试3次，第一次51000pages/min水平，第二第三次0pages/min。
